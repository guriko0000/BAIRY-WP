    ...
    <div class="l-inner">
      <div class="l-footer__container">
        <div class="l-footer__info-area">
          <div class="l-footer__logo"><a href="<?php echo esc_url(home_url()); ?>/"><img src="<?php echo esc_url( get_template_directory_uri()); ?>/assets/img/common/logo-black.svg" alt="" width="158" height="40" loading="lazy"></a></div>
              ...
              <div class="l-footer__nav-item-wrap">
                <div class="l-footer__nav-item">
                  ...
                  <div class="l-footer__nav-sns">
                    <a href="https://www.instagram.com/bairy1006/" target="_blank" rel="noopener noreferrer" class="l-footer__nav-sns-item"><img src="<?php echo esc_url( get_template_directory_uri()); ?>/assets/img/icon/icon_insta.svg" alt="Instagram" width="21" height="21" loading="lazy"></a>
                  </div>
                </div>
              </div>
            </div>
