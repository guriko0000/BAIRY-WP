              ...
              <ul class="p-recruit__type-list l-grid l-grid--col2">
                <li class="c-recruit">
                  <a href="/recruit-jobs/single-jobs/">
                    <h4 class="c-recruit__title">【リーダー候補】自社PBの販売代理店向け営業</h4>
            ...
            <div class="p-recruit__attract-media">
              ...
              <div class="p-recruit__media-video-area">
                <div class="p-recruit__media-video">
                  ...
                  <img src="/assets/img/under/attractiveness_img.png" alt="" width="367" height="275" loading="lazy">
                </picture> -->
                  <video src="/assets/img/movie/mv_video.mp4" poster="/assets/img/under/attractiveness_img.png" controls></video>
                </div>
              </div>
            </div>
          </div>
...
<?php if( get_field('staff_text') ) { ?>
  ...
  <?php endif; wp_reset_postdata(); ?>
            ...
            <!-- <a href="<?php echo esc_url(home_url()); ?>/voice/" class="c-voice">
              ...
              <div class="c-voice__img-area">
                <div class="c-voice__img">
                  <img src="/assets/img/under/voice_img02.jpg" alt="" width="300" height="219" loading="lazy">
                </div>
              </div>
            </a>
          </div> -->
            ...
            <ul class="p-recruit__benefits-list c-benefits">
              <li class="c-benefits__item">
                <div class="c-benefits__head">
                  ...
                  <span class="c-benefits__icon"><img src="/assets/img/icon/benefits_icon01.svg" alt="" width="45" height="45" loading="lazy"></span>
                </div>
